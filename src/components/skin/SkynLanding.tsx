...
}: {user?: User | null;hasCompletedScan: boolean;onGoToScan: () => void;onGoToCoach?: () => void;}) {
...
}: {latestAnalysis?: LatestAnalysis | null;previousAnalysis?: PreviousAnalysis | null;onGoToScan: () => void;}) {
