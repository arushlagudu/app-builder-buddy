...
export default function Index() {
  ...
  const [activeTab, setActiveTab] = useState<'scan' | 'history' | 'progress' | 'scanner' | 'coach' | 'routines' | 'settings'>('scan');
      ...
      <main className="px-4 space-y-6">
        ...
        {activeTab === 'coach' && (
          !isPremium ? (
            <FirstScanRequired 
              ...
              description="Get daily personalized tips and weather-based recommendations."
              isPremiumFeature={true}
            />
          ) : hasCompletedFirstScan ? (
            <AISkinCoach 
        ...
        {activeTab === 'settings' && (
          <div className="space-y-4">
            ...
            {!isPremium && user && (
              <PremiumBanner onUpgrade={() => handleUpgrade('scan_limit')} />
            )}
          </div>
        )}
      </main>
