...
import { Sparkles, User, LogOut, Crown, Settings } from 'lucide-react';
        ...
        {activeTab === 'scanner' && (
          !isPremium ? (
            <FirstScanRequired 
              ...
              description="Scan products to check ingredient compatibility with your unique skin profile."
              isPremiumFeature={true}
            />
          ) : hasCompletedFirstScan ? (
            <ProductScanner 
        ...
        {activeTab === 'history' && (
          !isPremium ? (
            <FirstScanRequired 
              ...
              description="Access all your past scans and track your skin improvement journey."
              isPremiumFeature={true}
            />
          ) : (
            <HistoryView />
