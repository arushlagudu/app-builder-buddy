...
export default function Index() {
  ...
  const { isPremium, tokensRemaining, canScan, incrementScanCount, SCAN_TOKEN_COST } = useSubscription();
            ...
            {!analysisResults ? (
              <>
                ...
                {imageData && !isScanning && (
                  ...
                  >
                    {!isPremium && tokensRemaining !== Infinity && (
                      <span className="text-xs opacity-80 mr-2">({tokensRemaining.toLocaleString()} tokens)</span>
                    )}
                    Initiate Diagnostic
                  </button>
                )}
